    ...
    <>
      <div className="mb-4">
        ...
        <div className="flex overflow-x-auto space-x-4 mb-4">
          ...
          <button
            onClick={() => handleTabSelect('fourth')}
            className={`flex-shrink-0 py-1 px-6 text-sm font-semibold cursor-pointer rounded-full border-2 ${
              selectedTab === 'fourth' ? 'border-limeGreenOpacity text-lightPurple' : 'border-gray-500 text-gray-500'
            }`}
          >
            Fourth
          </button>
      ...
      <div className="bg-purplePanel text-lightPurple rounded-lg">
        ...
        {selectedTab === 'fourth' && <ScoutAttackers playersIn={players} />} {/* Replace with actual component */}
      </div>
    </>
  );
};
